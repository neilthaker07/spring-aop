...
public class AuthorizationAspect 
{
	...
	public void readCheck(JoinPoint joinPoint, String userId, String blogUserId) throws AccessDeniedExeption
	{
	...
	public void sharingCheck(JoinPoint joinPoint, String userId, String blogUserId, String targetUserId) throws AccessDeniedExeption 
	{
		if( !userId.equals(blogUserId) && 
			   ( users.isEmpty() || 
				 users.get(blogUserId) == null ||  
	...
	public void unsharingCheck(JoinPoint joinPoint, String userId, String targetUserId) throws AccessDeniedExeption
	{
	...
	public void commentCheck(JoinPoint joinPoint, String userId, String blogUserId, String message) throws AccessDeniedExeption
	{
		if( !userId.equals(blogUserId) && 
				( users.isEmpty() ||
				  users.get(blogUserId) == null ||
